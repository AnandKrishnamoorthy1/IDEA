...
inp = pd.read_excel(r"C:\Users\bfsbicoe14\Desktop\TEXT_ANALYSIS\NLP Text Analytics\Input\Input\output\1504_Settlement of Agency transactions_3_Sentence_Domain_NLP.xlsx",encoding='utf-8' )
...
def MultinomialNB_print_top(vectorizer, clf, class_labels,n=5):
...
MultinomialNB_print_top(vectorizer, clf, class_labels,5)
...
def ML_Sentence_Catrgorize(Sent_df,ML_Type='SVM_MultinomialNB_CountVect'):
    ...
    if ML_Type=="Random_Forest_CountVect":
        ...
        loaded_model = pickle.load(open(r'C:\Users\bfsbicoe14\Desktop\TEXT_ANALYSIS\NLP Text Analytics\Input\Input\ML_Models\MultinomialNB_CountVect.pkl', 'rb'))
        vect=pickle.load(open(r'C:\Users\bfsbicoe14\Desktop\TEXT_ANALYSIS\NLP Text Analytics\Input\Input\ML_Models\MultinomialNB_CountVect_vect.pkl', 'rb'))
    predict_class=loaded_model.predict(vect.transform(Sent_df.SNTC_TXT))
...
inp = pd.read_excel(r"C:\Users\bfsbicoe14\Desktop\TEXT_ANALYSIS\NLP Text Analytics\Input\Input\output\1504_MAS 639A Revised_21Nov16_3_Sentence_Domain_NLP.xlsx",encoding='utf-8' )
ML_Sentence_Catrgorize(inp)
...
for grp,df in inp.groupby("DOMAIN"):
    ...
    print(grp, "DOMAIN:")
    print(result)
    print(grp,"DOMAIN Without Stop Words:")
    print(result_SW)
